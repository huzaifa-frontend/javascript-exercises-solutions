function displayReceipt() {
    ...
    receiptHTML += "<p>Item 1: Price = " + priceItem1 + " PKR, Quantity = " + quantityItem1 + ", Total = " + totalCostItem1 + " PKR</p>";
    receiptHTML += "<p>Item 2: Price = " + priceItem2 + " PKR, Quantity = " + quantityItem2 + ", Total = " + totalCostItem2 + " PKR</p>";
